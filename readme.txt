...
* Available event data fields: event title, date, open/start time, price, price, image, event details
* Select Beginning events view, old evetns view and all events view.
